...
export function SkillDetail({ skill, relatedSkills, relatedTutorials }: SkillDetailProps) {
    ...
    <>
      ...
      <Card className="mb-6 sm:mb-8">
        <CardContent className="pt-4 sm:pt-6 px-2 sm:px-6">
          ...
          <div className="bg-gray-900 text-gray-100 p-3 sm:p-4 rounded-lg overflow-x-auto mb-3">
